...
export const CardsSummaryTemplateCustom = ({ locale, customer, channel }) => html`<div style="--titleColor: darkgreen; --bgCardColor: lightgreen"><mf-cards-summary locale="${locale}" customer="${customer}" channel="${channel}"></mf-cards-summary></div>`;
...
<Story name="Cards Summary Custom" height="220px" args={{ locale: 'es', customer: '0001', channel: 'cards-summary'}}>
  { CardsSummaryTemplateCustom.bind() }
</Story>
