...
export class CustomersListComponent implements OnInit {
  public displayedColumns: string[] = ['id', 'name', 'age', 'balance', 'entry'];

  public showCustomers = false;
  public customers: Customer[];

  constructor(private ngZone: NgZone, private router: Router, private customersService: CustomersService) { }
